...
def get_url(search_word, pageNum):
    ...
    default = 'https://www.amazon.ca/s?k={}&page={-}&qid=1610743240&ref=sr_pg_1'
...
def parse_record(item):
    """parse releveant information from HTML of ITEM"""
    #item NAME
    atag = item.h2.a 
    itemName = atag.text.strip()

    #item URL
    itemURL = 'https://www.amazon.com' + atag.get('href') #get item URL
...
def main():
    ...
    #Start the webdriver
    driver = webdriver.Chrome('C:\\Users\\Dylan\\chromedriver')

    search_term = input("Enter item to search Amazon.ca for: ")
    ...
    #save data
    with open('amazonRecords.csv', 'w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
